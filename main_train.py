...
def train(subject_name, exp_cfg, args=None):
    ...
    if 'nerf' in exp_cfg:
        ...
        cfg.ckpt_path = os.path.abspath(
            './exps/snapshot/male-3-casual/model.tar')  # any pretrained nerf model to have a better initialization
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--clean', action="store_true",
                        help='delete output dir if exists, if not, the training will be resumed.')
